...
public class testReflexiveGraph {

    public static void run(String algorithm, int nV, int nE, int seed){

        String graphType = "Reflexive graph";
        String file = "reflexive.csv";
        ...
        graph.addEdge(graph.getEdgeSource(randomEdge), graph.getEdgeSource(randomEdge));
