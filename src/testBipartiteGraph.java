...
public class testBipartiteGraph {
    ...
    public static void run(String algorithm, int nV, int nE, int division){

        String graphType = "Bipartite graph " + division;
        String file = "bipartiteResults"+ division+ ".csv";
        ...
        int n2 = (division - 1)*nV/division;
        int n1 = nV/division;
        GnmRandomBipartiteGraphGenerator generator;
        generator = new GnmRandomBipartiteGraphGenerator<>(n1, n2, nE);
